  ...
  return (
    <div className="new-colour-group-form-page">
      <div className="new-colour-group-form-div">
        ...
        <NewColourGroupForm newColourGroup={newColourGroup} setNewColourGroup={setNewColourGroup} submitForm={submitForm}/>
      </div>

      <div className="new-colour-form-div">
        <h2>New Colour Form</h2>
        <NewColourForm newColourGroup={newColourGroup} setNewColourGroup={setNewColourGroup}/>
      </div>
    </div>
  );
}
...
// ----------------------------------------------------------------------------------------------------
function NewColourGroupForm({newColourGroup, setNewColourGroup, submitForm}){
  return (
    <form
      onSubmit={(e) => {
        e.preventDefault();
